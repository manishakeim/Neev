...
public class PieFragment extends Fragment {		
	...
	@Override
		...
		View view = (LinearLayout) inflater.inflate(R.layout.fragment_pie,container, false);
		...
		//int pos = distribution.length;in.getIntExtra("pos",value);
	...
	private void openChart2(final String[] code, final double[] distribution, final double[] unit_price){    	
        ...
        chart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              	 Intent intent = new Intent(getActivity().getApplicationContext(), PieChart2.class); 
