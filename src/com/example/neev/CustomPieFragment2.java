...
public class CustomPieFragment2 extends Fragment {		
	LinearLayout chartContainer1;
	@Override
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = (LinearLayout) inflater.inflate(R.layout.activity_custom_pie_fragment2,container, false);
	...
	private void openChart2(final String[] code, final double[] distribution, final double[] unit_price){    	
        ...
        chart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              	 Intent intent = new Intent(getActivity().getApplicationContext(), CustomPieChart4.class); 
