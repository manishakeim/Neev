...
public class DashboardActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menuitem_dashboard:
			Toast.makeText(this, getString(R.string.ui_menu_dashboard),
					Toast.LENGTH_SHORT).show();
			return true;
		case R.id.menuitem_export:
			Toast.makeText(this, getString(R.string.ui_menu_export),
					Toast.LENGTH_SHORT).show();
			/*Intent i2 = new Intent(getApplicationContext(), Export.class);
			startActivity(i2);
			*/
			return true;
			//break;
		case R.id.menuitem_update:
			Toast.makeText(this, getString(R.string.ui_menu_update),Toast.LENGTH_SHORT).show();	
			Intent i1 = new Intent(getApplicationContext(), UpdateActivity.class);
			startActivity(i1);
		default:
