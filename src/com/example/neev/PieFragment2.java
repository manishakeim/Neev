...
public class PieFragment2 extends Fragment {
	LinearLayout chartContainer2;
	@Override
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = (LinearLayout) inflater.inflate(R.layout.fragment_pie_fragment2,container, false);
		...
		openChart(code, distribution, unit_price);
		
		return view;
	}

private void openChart(final String[] code, final double[] distribution, final double[] unit_price) {       	
    	...
    	*/
    	...
    	CategorySeries distributionSeries = new CategorySeries(" Values ");
    	
    	for(int i=0 ;i < distribution.length;i++) {
    		// Adding a slice with its values and name to the Pie Chart
    		distributionSeries.add(code[i] + "(" + distribution[i]+")", distribution[i]);  
    	}   
        ...
        mchart.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
               	 Intent intent = new Intent(getActivity().getApplicationContext(), PieChart3.class); 
