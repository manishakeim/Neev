...
public class CustomPieFragment extends Fragment {		
	LinearLayout chartContainer1;
	@Override
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = (LinearLayout) inflater.inflate(R.layout.activity_custom_pie_fragment,container, false);
	...
	private void openChart2(final String[] code, final double[] distribution, final double[] unit_price){    	
    	...
    	defaultRenderer.setChartTitle("Inventory");
        ...
        chart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              	 Intent intent = new Intent(getActivity().getApplicationContext(), CustomPieChart3.class); 
